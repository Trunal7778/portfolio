            ...
            >
              ...
              <div className="p-6 sm:p-8 rounded-3xl border border-slate-200/60 dark:border-slate-800 bg-white dark:bg-[#1E293B]/20 backdrop-blur-md hover:shadow-xl dark:hover:border-sky-500/20 hover:border-blue-500/20 transition-all duration-300">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                  <div>
                    <h4 className="text-xl font-bold font-poppins text-slate-850 dark:text-white">
                      {edu.degree}
                    </h4>
                    <p className="text-sm font-semibold text-blue-600 dark:text-sky-400 mt-0.5">
                      {edu.institution}, {edu.location}
                    </p>
                  </div>

                  {/* Calendar Period Badge */}
                  <span className="px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/80 text-xs font-semibold text-slate-500 dark:text-slate-400 flex items-center gap-1.5 w-fit select-none">
